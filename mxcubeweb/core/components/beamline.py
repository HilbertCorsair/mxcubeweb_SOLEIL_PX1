...
class Beamline(ComponentBase):
    ...
    def get_viewport_info(self):
        ...
        if self.app.CONFIG.app.VIDEO_FORMAT == "MPEG1":
            ...
            video_sizes = HWR.beamline.sample_view.bear.get_available_stream_sizes()
            (width, height, scale) = HWR.beamline.sample_view.bear.get_stream_size()
        else:
            scale = 1
            width = HWR.beamline.sample_view.bear.get_width()
            height = HWR.beamline.sample_view.bear.get_height()
        ...
        data = {
            ...
            "scale": scale,
            "videoSizes": video_sizes,
            "videoHash": HWR.beamline.sample_view.bear.stream_hash,
